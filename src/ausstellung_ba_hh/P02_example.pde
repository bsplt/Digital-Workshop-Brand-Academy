public class P02 extends Performer {
  ...
  String NAME = "Alex";
  String TITLE = "plyPhon";
  String ARTIST = "Autechre";
  String TRACK_FILE = "P02_Autechre - plyPhon.mp3";

  color BACKGROUND = #64AF28;
  color FRAME = #FFFFFF;
  float FRAME_MARGIN = 0.075;
  float COLOR_CHANGE_SPEED = 3.0;
  String LAYOUT_FONT_NAME = "P02_layout-font.otf";
  color LAYOUT_FONT = #333333;
  float LAYOUT_FONT_SIZE = 0.017;

  float AUDIO_SMOOTH_FACTOR = 0.03;

  PVector MOVEMENT = new PVector(0, 0, -3000);
  PVector OFFSET = new PVector(0, 0, -1000);

  color[] FLOATING_BACKGROUND = {#33C623, #A4C623};
  ...
  String FONT_NAME = "P02_SpaceMono-Bold.ttf";
  color FONT = #242F40;
  float FONT_SIZE = 0.2;
  ...
  color PRIMITIVE_BORDER = #090C08;
  float PRIMITIVE_BORDER_VISIBILITY = 1.0;
  float PRIMITIVE_BORDER_THICKNESS = 2.0;
  float PRIMITIVE_SIZE = 0.6;
  float PRIMITIVE_DURATION = 3.0;

  color BLOB_FILL = #FF01FB;
  float BLOB_FILL_VISIBILITY = 1.0;
  color BLOB_BORDER = #090C08;
  float BLOB_BORDER_VISIBILITY = 0.0;
  float BLOB_BORDER_THICKNESS = 2.0;
  float BLOB_SIZE = 0.07;
  float BLOB_DURATION = 2.0;
  ...
  color SHUTTER = #F7F7FF;
  float SHUTTER_DURATION = 2.0;
  float SHUTTER_SCALE = 1.5;

  color WALL_FILL = #333333;
  float WALL_FILL_VISIBILITY = 0.0;
  color WALL_BORDER = #090C08;
  float WALL_BORDER_VISIBILITY = 1.0;
